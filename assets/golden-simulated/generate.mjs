...
function writeBackendImplementation() {
  ...
  const operationTokenSource = source
    ...
    .replace("const id='resource-'+checksum.slice(0,12);return json", "const id='resource-'+checksum.slice(0,12);RESOURCE_STORE.set(id,file.toString('base64'));return json")
